                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th hidden="true">id fabricante</th>
                                                <th>Nombre</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listaFabricante}" var="ver">
                                                <tr>
                                                    ...
                                                    <td hidden="true">${ver.id_fabricante}</td>
                                                    <td>${ver.nombre_fabricante}</td>
                                                    <td>${ver.numero_producto}</td>
                                                    <td>${ver.estado}</td>
                                                    <td>${ver.fecha_ingreso}</td>
                                                    <td>
                                                        <a href="fabricante?action=mostrarEditar&id=${ver.id_fabricante}">
                                                    ...
                                                    <td>
                                                        <a href="contactos?action=eliminar&id=">
                                                            <button type="button" class="btn btn-default btn-sm">
