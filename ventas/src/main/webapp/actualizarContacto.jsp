                                    ...
                                    <form role="form" action="contactos?action=editar" method="POST">
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>Nombres: </label>
                                                    <input class="form-control" name="nombre_cliente" value="${ver.nombre}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Apellidos:  </label>
                                                    <input class="form-control" name="apellido_cliente" value="${ver.apellido}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Correo:  </label>
                                                    <input class="form-control" name="correo" value="${ver.email}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Teléfono:  </label>
                                                    <input class="form-control" name="telefono_cliente"value="${ver.telefono}">
                                                </div>
                                                <div class="form-group">
