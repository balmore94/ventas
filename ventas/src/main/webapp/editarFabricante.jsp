                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <c:forEach items="${listaId}" var="ver">
                                <form class="form-horizontal" method="POST" action="fabricante?action=updateFabricante">

                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#details" data-toggle="tab" aria-expanded="false">Detalles del fabricante</a></li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="details">
                                                ...
                                                <div class="form-group " hidden="true">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" value="${ver.id_fabricante}" class="form-control" name="codigo_producto">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" value="${ver.nombre_fabricante}" class="form-control" name="nombre_producto" required >
                                                    </div>
                                                </div>
